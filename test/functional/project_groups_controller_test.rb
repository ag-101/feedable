...
class ProjectGroupsControllerTest < ActionController::TestCase
  ...
  test "should create project_group" do
    assert_difference('ProjectGroup.count') do
      post :create, :project_group => { :name => @project_group.name, :project_id => @project_group.project_id, :type => @project_group.type, :user_id => @project_group.user_id }
    end
  ...
  test "should update project_group" do
    put :update, :id => @project_group, :project_group => { :name => @project_group.name, :project_id => @project_group.project_id, :type => @project_group.type, :user_id => @project_group.user_id }
    assert_redirected_to project_group_path(assigns(:project_group))
  end
